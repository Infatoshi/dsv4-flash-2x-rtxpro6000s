#!/bin/bash
# Long-context config (validated 2026-08-04): 512k max len, 2 seqs, graphs, NO spec decode.
# Pool: 838k tokens = 1.60x concurrency at 512k. Decode at 100k ctx: ~95 tok/s.
# Prefill ~1.7k tok/s at 100k. 1M x 1 seq also fits (eager probe: 1.54x headroom).
